...
const PrincipalPage = () => {
    ...
    const textoArray = [ 
        "La historia del Restaurante La Pista es una verdadera historia de emprendimiento y pasión por los negocios.",
        
        " Todo comenzó en 2007 cuando dos primos, Miguel y Rodrigo, decidieron empezar un proyecto juntos. Su idea inicial era construir un club de carros de control remoto, y tras investigar y buscar la representación de una marca japonesa, se pusieron manos a la obra para construir la primera pista de carritos off-road de Guatemala.",

        "No solo construyeron la pista, también levantaron una cabaña de madera rústica que le dio al lugar un encanto único. La madre de Miguel, Ana, fue la encargada de llevar adelante la construcción y poner su propio estilo en ella.",
        
        "Así fue como en 2007 nació el club GTZ RACING, y rápidamente se convirtió en un éxito. Los fines de semana había competencias, eran más de 40 socios que pagaban su membresía y compraban carritos y repuestos. Con el tiempo, la gente empezó a referirse al lugar como 'La Pista'.", 
        
        "En 2008, sin embargo, algo inesperado empezó a cambiar la dirección del negocio.", 
        
        " El hermano de Rodrigo, el Chef Rick, diseñó 4 bocatas para vender a los socios del club, pero pronto empezaron a llegar clientes que no tenían nada que ver con los carritos de control remoto. Las bocatas se volvieron famosas, y cada día llegaban más clientes al lugar.",
        
        "En 2009, Chef Rick se unió oficialmente al equipo y decidieron transformar el lugar en un restaurante al 100%.", 
        
        " Con el apoyo de sus padres, pudieron poner el lugar en condiciones, comprar equipo y vajilla, y un tío les regaló todas las mesas y sillas para el restaurante. El lugar quedó rústico y encantador, y en honor a su historia, decidieron mantener el nombre de La Pista.",
        
        "Sin embargo, la primera decisión importante que tomaron fue cerrar el club de carritos para dedicarse de lleno al restaurante.", 
        
        "Se propusieron una regla fundamental: lo único que importa es que los clientes se vayan contentos. En la noche de la apertura, imprimieron el primer menú en papel bond sin saber si los clientes encontrarían el lugar, pero con mucha fe y la experiencia del Chef Rick, empezaron a recibir mesas desde el primer turno.",
        ...
        <div className='principalPage'>
            ...
            <section id='servicios' className="services">
                <div className='services__content'>
                    <Title title1="Fine Dining"  color="#fff" fontsize="32px" center/>
                                ...
                                if (index % 2 === 0) {
                                    return (
                                        <SwiperSlide key={index}>
                                            <img src={`/images/nosotros${(index / 2) + 1}.png`} alt={`nosotros${(index / 2) + 1}`} className="nosotros__img"/>
                                            <p className='nosotros__text'>{parrafo}</p>
                                            <p className='nosotros__text'>{textoArray[index + 1]}</p>
                                        </SwiperSlide>
                                    );
                                }
                                return null;
            ...
            <section id='contact' className="contact">
                <Title title1="CONTACTO" color="#fff" fontsize="80px"/>
